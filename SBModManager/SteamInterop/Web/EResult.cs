...
namespace SBModManager.SteamInterop.Web {
	...
	/// <summary>
	/// Results from the Steam API. This is sourced directly from Valve themselves.
	/// </summary>
	public enum EResult {
		/// <summary>
		/// Not part of the steam API. This code indicates that the code used to actually figure out
		/// the result failed, typically indicating an exception.
		/// </summary>
		Undefined = 0,
